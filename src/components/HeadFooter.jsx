...
const HeadFooter = () => {
  return (
    <div className=" min-h-screen lg:min-h-[450px] lg:h-[450px]  bg-primary grid grid-cols-1 md:grid-cols-2 relative ">
      {/* <div className="absolute inset-0 bg-cover bg-center opacity-50">
        <img src="/pop/image-12.png" alt="" className="w-full h-full object-cover" />
        </div> */}
      <div className="max-w-7xl mx-auto  ">
        <div className=" mt-10 lg:mt-20 lg:max-w-3xl px-10 lg:px-20">
          <h1 className=" text-2xl lg:text-6xl font-Roboto font-bold text-white">
        ...
        <div className="md:absolute -top-20 right-[10%] items-center justify-center">
